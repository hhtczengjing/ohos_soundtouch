...
static void setup(SoundTouch *pSoundTouch, const WavInFile *inFile, RunParameters *params)
{
    int sampleRate;
    int channels;
...
int run(const char *inFileName, const char *outFileName, RunParameters *params) {
    try
    {
        // Open input file
        WavInFile *inFile = new WavInFile(inFileName);
        ...
        WavOutFile *outFile = new WavOutFile(outFileName, samplerate, bits, channels);
